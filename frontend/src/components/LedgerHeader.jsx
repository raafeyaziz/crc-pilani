...
export default function LedgerHeader({ledgerData}){
    return (
        ...
        <div>
            <p className={`md:text-5xl  text-3xl w-full flex items-center justify-center ${
            ...
            <p className='text-grey text-sm md:text-base w-full flex items-center justify-center'>
            net balance
            </p>
        </div>
        <div className='w-full gap-4 flex items-center'>
            <div className='flex flex-col w-1/2 justify-center items-start'>
            <p className='text-green text-2xl md:text-4xl flex w-full justify-center'> 
            ...
            <p className='text-red text-2xl md:text-4xl flex justify-center'> 
